...
dying = 0 hit = 0 dyingdelay = 0
see = 0 objectUI.scr = 100 objectUI.deathcheck = 0 objectUI.landercheck = 0 y = 118
...
objectUI.baitersp = 0 objectUI.alarm[4] = 0 objectUI.alarm[0] = 30
}
else {
global.gamestart = 0
